...
const TimelineItem = ({ role, company, year, icon: Icon }) => (
  <div className="relative pl-8 pb-5">
    <span className="absolute left-2 top-1.5 h-2.5 w-2.5 rounded-full bg-indigo-500 shadow ring-4 ring-white"></span>
    <div className="absolute left-3 top-3 bottom-0 w-0.5 bg-gray-200"></div>
    <div className="bg-white rounded-xl shadow-sm p-3 border border-gray-100">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-semibold text-gray-900 flex items-center gap-2"><Icon size={14} className="text-indigo-600" />{role}</h4>
